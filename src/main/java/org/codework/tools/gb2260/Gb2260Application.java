...
import org.codework.tools.gb2260.config.redis.RegisterListener;
...
public class Gb2260Application {

	public static void main(String[] args) {
		SpringApplication.run(Gb2260Application.class, args);
//		SpringApplication application = new SpringApplication(Gb2260Application.class);
//			application.addListeners(new RegisterListener());
